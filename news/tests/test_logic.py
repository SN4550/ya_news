...
class TestCommentCreation(TestCase):
    ...
    def test_user_can_create_comment(self):
        """
            Второй тест: убедимся, что пользователь может создать комментарий.
        """
    ...
    def test_user_cant_use_bad_words(self):
        """
            Теперь проверим, что пользователь не может использовать запрещённые слова при комментировании.
        """
...
class TestCommentEditDelete(TestCase):
    ...
    def setUpTestData(cls):
        ...
        # Добавляем адрес блока с комментариями.
